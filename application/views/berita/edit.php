...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
    	<div class="card-header py-3">
    		<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-plus-square"></i> Edit Berita</h6>
    	</div>
    	<div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="<?= base_url('berita/edit_save') ?>">
                ...
                <div class="form-group">
                    ...
                    <input name="tgl_berita" class="form-control" type="date" value="<?= $tgl_berita ?>" required>
                </div>
                ...
                <div class="form-group">
                    <!-- <a class="btn btn-info btn-sm" href="<?= base_url("berita")?>"><i class="fas fa-save"></i> Simpan</a> -->
