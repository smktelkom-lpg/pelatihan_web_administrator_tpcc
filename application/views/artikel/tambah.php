...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
    	<div class="card-header py-3">
    		<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-plus-square"></i> Tambah Artikel</h6>
    	</div>
    	<div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="<?= base_url('artikel/tambah_save') ?>">
                ...
                <div class="form-group">
                    ...
                    <input name="tgl_artikel" class="form-control" type="date" required>
                </div>
